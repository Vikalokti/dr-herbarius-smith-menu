    ...
    main.innerHTML = `
      <div class="page-enter">
        ...
        <div class="contacts-section">
          ...
          <p class="contacts-desc">Погружение в проект и прямая связь с основателем</p>
    ...
    html += `
      <div class="drink-section">
        <div class="share-block">
          <div class="share-title">Поделиться напитком</div>
          <div class="share-buttons">
            <a href="https://t.me/share/url?url=${encodeURIComponent(window.location.href)}&text=${encodeURIComponent(drink.nameRu + ' — ' + (drink.functionRu || drink.functionShort))}" target="_blank" class="share-btn">
              <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20"><path d="M11.944 0A12 12 0 1 0 24 12.056A12.01 12.01 0 0 0 11.944 0Zm5.654 7.304l-1.97 9.28c-.146.658-.537.818-1.084.508l-3-2.21-1.446 1.394c-.16.16-.295.295-.605.295l.213-3.053 5.56-5.023c.242-.213-.054-.334-.373-.121l-6.871 4.326-2.962-.924c-.643-.204-.657-.643.136-.953l11.57-4.461c.537-.194 1.006.131.832.942Z"/></svg>
              Telegram
            </a>
            <a href="https://wa.me/?text=${encodeURIComponent(drink.nameRu + ' — ' + (drink.functionRu || drink.functionShort) + '\n' + window.location.href)}" target="_blank" class="share-btn">
